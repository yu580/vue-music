<template>
  ...
  @scroll="scroll">
    ...
    <div class="list-shortcut" @touchstart="onShortcutTouchStart" @touchmove.stop.prevent="onShortcutTouchMove">
      <ul>
        <li v-for="(item,i) in shortcutList" :key="i" :data-key="i" class="item" :class="{'current':currentIndex===i}">{{item}}</li>
      </ul>
    </div>
...
export default {
  ...
  methods: {
    ...
    onShortcutTouchStart(e) {
      let shortcutIndex = getData(e.target, "data-key");
      let touchstart = e.touches[0];
      this.touch.y1 = touchstart.pageY;
      this.touch.index = shortcutIndex;
